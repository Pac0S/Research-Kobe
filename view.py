...
class WorldView(tk.Canvas):
	...
	def __init__(self, window, w=300, h=180, color="black"):
		...
		for i in range (proteome.shape[0]):
			for j in range (proteome.shape[1]):
				...
				if aa.rigid == 0 and aa.shearable == 0 : #Fluid non shearable : Red
					oval = self.create_oval(aa.column*10,aa.line*10, (aa.column+1)*10, (aa.line+1)*10, fill = "Red")
					...
					oval = self.create_oval(aa.column*10,aa.line*10, (aa.column+1)*10, (aa.line+1)*10, fill = "Blue")
					...
					oval = self.create_oval(aa.column*10,aa.line*10, (aa.column+1)*10, (aa.line+1)*10, fill = "Grey")
					#print(aa.column*10,aa.line*10, (aa.column+1)*10, (aa.line+1)*10, "Draw grey")
					
				else : #Black, should not be possible
					oval = self.create_oval(aa.column*10,aa.line*10, (aa.column+1)*10, (aa.line+1)*10, fill = "Black")
...
if __name__ == "__main__":
	...
	mysquare = WorldView(frame1, 300,180)
